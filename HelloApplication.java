...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) throws IOException, ClassNotFoundException {
        ...
        int longeur = 10;
        int largeur = 10;
        test = new Labyrinthe(longeur, largeur);
        ...
        récup.GetCellule(5, 5).setElement(null);
        //System.out.println("les voisins sont"+récup.getVoisins(8,8));
        //System.out.println("les voisins sont"+récup.getVoisins(4,4));

        Image image = new Image("C:\\Users\\Loick\\Desktop\\SAE-R2.01-Theos\\Herbe.Png");
        Image image2 = new Image("C:\\Users\\Loick\\Desktop\\SAE-R2.01-Theos\\Mur.Png");
        Image image3 = new Image("C:\\Users\\Loick\\Desktop\\SAE-R2.01-Theos\\cactus.jpg");
        Image image4 = new Image("C:\\Users\\Loick\\Desktop\\SAE-R2.01-Theos\\Margeurites.jpg");
        Image image5 = new Image("C:\\Users\\Loick\\Desktop\\SAE-R2.01-Theos\\Terre.png");
        Image image6 = new Image("C:\\Users\\Loick\\Desktop\\SAE-R2.01-Theos\\Terre.png");
        Image image7 = new Image("C:\\Users\\Loick\\Desktop\\SAE-R2.01-Theos\\Mouton.png");
        Image image8 = new Image("C:\\Users\\Loick\\Desktop\\SAE-R2.01-Theos\\Loup.png");
        /*
        Image image = new Image("Herbe.Png");
        Image image2 = new Image("Mur.Png");
        Image image3 = new Image("cactus.jpg");
        Image image4 = new Image("Margeurites.jpg");
        Image image5 = new Image("Terre.png");
        Image image6 = new Image("Terre.png");
        Image image7 = new Image("Mouton.png");
        Image image8 = new Image("Loup.png");
        */
        ...
        for (int row = 0; row < récup.getNy(); row++) {
            for (int col = 0; col < récup.getNx(); col++) {
                ...
                if (récup.GetCellule(col, row).getElement() instanceof Mur) {
                    button.setBackground(background2);
                } else if (récup.GetCellule(col, row).getElement() instanceof Cactus) {
                    button.setBackground(background3);

                } else if (récup.GetCellule(col, row).getElement() instanceof marguerite) {
                    button.setBackground(background4);

                } else if (récup.GetCellule(col, row).getElement() == null) {
    ...
    public void handle(MouseEvent event) {
        ...
        Scene scene = new Scene(gridPane, longeur*50, largeur*50);
