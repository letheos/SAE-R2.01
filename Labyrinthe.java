...
public class Labyrinthe implements Serializable {
    ...
    public boolean DéfinirSortie(int x, int y) {
        ...
        if (cellules.get(x).get(y).getElement() instanceof Végétal) {
    ...
    public ArrayList<Cellule> getVoisins(Cellule cellule ) {
        ...
        if (this.cellules.get(cellule.getX() - 1).get(cellule.getY()).getElement() instanceof Végétal) {
        ...
        if (this.cellules.get(cellule.getX()).get(cellule.getY() + 1).getElement() instanceof Végétal) {
